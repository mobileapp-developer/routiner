    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                <BackButton/>
                <Text style={[styles.headerText, {right: 80}]}>Create Custom Habit</Text>
            </View>
            ...
            <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
                ...
                <Animated.View style={[styles.footer, {transform: [{scale: scaleValue}]}]}>
                    <Pressable style={styles.addButton} onPress={handleSubmit} onPressIn={onPressIn} onPressOut={onPressOut}>
