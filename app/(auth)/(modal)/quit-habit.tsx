        ...
        <Pressable style={styles.overlay} onPress={() => router.back()}>
            <Animated.View style={[styles.sheet, {backgroundColor: palette.primary.white, transform: [{translateY: slideValue}]}]}>
                <Pressable onPress={(e) => e.stopPropagation()} style={styles.content}>
                    ...
                    <Text style={[styles.label, {color: palette.primary.black[40]}]}>QUIT BAD HABIT</Text>

                    <Pressable style={[styles.customButton, {borderColor: palette.primary.black[10]}]} onPress={() => router.push('/(auth)/(habit)/quit-habit')}>
                    ...
                    <Text style={[styles.label, {color: palette.primary.black[40]}]}>POPULAR BAD HABITS</Text>
